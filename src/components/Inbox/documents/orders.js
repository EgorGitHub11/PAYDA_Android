...
export default class orders extends Component {
  ...
  getData(){
    ...
    const url = mainUrl+`/api/archive/${pk}/`
      ...
      .then((response) => {
        ...
        this.setState({arr: response.data.orders})
        this.setState({docUrl: response.data.orders[0].file})
  ...
  render() {
    ...
    return (
      ...
      <Header navigation={this.props.navigation} name={'ПЛАТЕЖНЫЕ ПОРУЧЕНИЯ'}/>
